...
def add_form_factors(parser, required=False):
    ...
    gme.add_argument('-F',
                     ...
                     metavar='FF,A',
                     help=(
                         '(form factor, departure angle) tuple - used to'
                         ' specify a set of form factors that will be used to'
                         ' determine the form factor for a given shot by'
                         ' interpolation'
                     ))
...
def set_common_defaults(parser):
    ...
    parser.add_argument('-V', '--version',
                        action='version',
                        version="Master Exterior Ballistics version %s" % (
                            version.__version__),
